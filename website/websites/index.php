...
$langs = array(
   ...
   array('jruby','JRuby','everything is an object scripting for jvm','jruby',$basesite),
   ...
   array('oz','Mozart/Oz','multi-multi-multi-paradigm distributed programming','oz',$onecoresites),
