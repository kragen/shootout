      ...
      for ($col=0; $col<NCOLS; $col++){
         ...
         if (isset($cols[$col][$row])){
            ...
            if (isset($Langs[$k][LANG_SPECIALURL]) && !empty($Langs[$k][LANG_SPECIALURL])){
               printf('<a href="%s.php" title="Compare %s size and speed against one other programming language">', $Langs[$k][LANG_SPECIALURL], $Langs[$k][LANG_FULL]);
            } else {
            ...
            printf('<img src="chartshape.php?w=%s&amp;s=%s&amp;c=%s" alt="source code size versus speed of %s benchmark programs" title="Which programming language is fastest? Compare %s" width="150" height="120" />',
