...
<p>Each chart box shows the middle 50% of program time &#247; <em>fastest</em> program time and each horizontal black bar shows <a href="#about">&darr;&nbsp;the median</a> program time &#247; <em>fastest</em> program time, for 10 tiny tasks.</p>
