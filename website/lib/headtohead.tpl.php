...
<p>For each of one our benchmarks, a white bar shows which language implementation had the better time, and a black bar <a href="faq.php#mirrorcharts">shows which had the better</a> memory use.</p>
