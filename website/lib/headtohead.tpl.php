...
printf('<p><strong>Check</strong> for <a href="#measurements" title="See %s measurements">benchmarks with no %s program</a>, or Timeout/Error.</p>', 
   $LangName, $LangName);
...
<tr><td>
<h4 class="rev"><a class="arev" href="#measurements" name="measurements">&nbsp;<?=$LangName;?> measurements</a></h4>
</td></tr>
