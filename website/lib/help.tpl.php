...
href="./u32/compare.php?lang=java&amp;lang2=python3" title="Compare the speed and size of Java 6 -server programs against Python 3 programs.">&nbsp;Ubuntu&#8482;&nbsp;:&nbsp;Intel&#174;&nbsp;Q6600&#174;&nbsp;one core&nbsp;</a></span> select <a href="./u32/compare.php?lang=java&amp;lang2=python3" title="Compare the speed and size of Java 6 -server programs against Python 3 programs">all benchmarks</a> select <a href="./u32/compare.php?lang=java&amp;lang2=python3" title="Compare the speed and size of Java 6 -server programs against Python 3 programs">Java -6 server</a> select <a href="./u32/compare.php?lang=java&amp;lang2=python" title="Compare the speed and size of Java 6 -server programs against Python 3 programs">Python 3</a> in the drop-down menus.</p>
</dd>
