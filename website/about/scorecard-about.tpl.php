<p>For each benchmark, <strong>B</strong> is the best measurement; for each language implementation, the best measurement <strong>L</strong> is converted to the <em>ratio</em> <strong><sup>L</sup>/<sub>B</sub></strong>

<p>The ratio can be adjusted by a measurement multiplier (make CPU time or memory use or
source size more or less important) and by a benchmark weight (make particular benchmarks more or less important).</p>
