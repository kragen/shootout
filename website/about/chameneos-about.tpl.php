<p><b>ndiff</b> program output N = 100 with this <a href="iofile.php?test=<?=$SelectedTest;?>&amp;lang=<?=$SelectedLang;?>&amp;file=output">output file</a> to check your program is correct before contributing.
</p>

<p>Programs may use kernel threads, lightweight threads&#8230; <b>cooperative threads&#8230; and other programs with custom schedulers will be listed as interesting alternative implementations</b>. Briefly say what concurrency technique is used in the program header comment.</p>
