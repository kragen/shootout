...
<p>Each program should create and keep alive, 503 threads linked in an unbroken ring, and pass a message between one thread and the next thread at least N times. Programs may use kernel threads, lightweight threads, cooperative threads&#8230;</p>
