...
<p>Each program should create and keep alive, 503 threads linked in an unbroken ring, and pass a value between one thread and the next thread at least N times. Programs may use kernel threads, lightweight threads&#8230; (cooperative threads&#8230; and other programs with custom schedulers will be listed as interesting alternative implementations). Briefly say what concurrency technique is used in the program header comment.</p>
