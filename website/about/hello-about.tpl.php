<p>Each program should be implemented the <a
  href="faq.php?sort=<?=$Sort;?>#sameway"><b>same&nbsp;way</b></a> - the same way as this <a href="benchmark.php?test=hello&lang=perl&sort=<?=$Sort;?>">Perl program</a>.</p>
...
<p>The CPU Times measured in this test are used to adjust <a
  href="faq.php?sort=<?=$Sort;?>#cpu"><b>CPU Time</b></a> for the other benchmarks.</p>