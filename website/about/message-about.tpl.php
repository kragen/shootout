...
<p>Each program should create, keep alive, and <em>send N integer messages</em> between 500 explicitly-linked threads. Programs may use kernel threads, lightweight threads, cooperative threads&#8230;</p>
