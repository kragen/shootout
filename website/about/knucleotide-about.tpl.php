...
<ul>
  ...
  <li>define a procedure/function to update a <strong>hashtable</strong> of k-nucleotide keys and count values, for a particular reading-frame &#8212; even though we'll combine k-nucleotide counts for all reading-frames (grow the <strong>hashtable</strong> from a small default size)</li>
