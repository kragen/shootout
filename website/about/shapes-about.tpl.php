...
<p><br/>There are other ways to analyse and present this data: ask <a href="fastest.php?d=<?=$DataSet?>">Which programming languages have the fastest programs?</a> or <a href="fun.php?d=<?=$DataSet?>">Which are best for you?</a> or take the <a href="summarydata.php?d=<?=$DataSet?>">Summary Data</a> and do your own analysis!</p>
