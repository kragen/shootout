<p>For each benchmark, <strong>F</strong> is the fastest time measurement; for each language implementation, each time measurement <strong>T</strong> is then converted to <strong>log<sub>10</sub><sup>T</sup>/<sub>F</sub></strong></p>
