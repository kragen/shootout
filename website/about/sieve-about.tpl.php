<p>Each program should be implemented the <a href="faq.php?sort=<?=$Sort;?>#sameway"><strong>same&nbsp;way</strong></a> - the same way as this <a href="benchmark.php?test=sieve&lang=gcc&sort=<?=$Sort;?>">C program</a>.



<p>Count the prime numbers from 2 to 8192 N times.</p> 

<p>Find the prime numbers with Eratosthenes Sieve:
