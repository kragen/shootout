...
<p>Correct output for this 345KB <a href="iofile.php?test=<?=$SelectedTest;?>&lang=<?=$SelectedLang;?>&sort=<?=$Sort;?>&file=input">input file</a> (file content duplicated N = 5 times) with this 345KB <a href="iofile.php?test=<?=$SelectedTest;?>&lang=<?=$SelectedLang;?>&sort=<?=$Sort;?>&file=dict">Usr.Dict.Words file</a> is: 
<pre>
zuul
zuul
zuul
