...
<p>For N = 7 programs should generate <a href="iofile.php?test=<?=$SelectedTest;?>&amp;file=extra">these permutations</a> (40KB) - the same order as the Tompkins-Paige algorithm, see pages 150-151 <a href="http://www.princeton.edu/~rblee/ELE572Papers/p137-sedgewick.pdf">Permutation Generation Methods</a> Robert Sedgewick (pdf).</p>
