...
<p>For this test, each program should be implemented to do the <a
  href="../../method.php#sameway"><i>same thing</i></a>, multiply 2
  matrices.  For this test, I would like to see solutions that do not
  manually unroll the loops.</p>
<p>This test is inspired by another small language comparison: <a
...
<p>The following programs exceed the time limit (300 CPU seconds) and
 ...
 <a href="matrix.mawk">Mawk</a></p>
<p>The OCaml solution is just as fast as the C/C++ solutions, until we
 add the <i>-funroll-loops</i> optimization option to our gcc/g++
 programs, which naturally gives them a small advantage.</p>

<p>Per Hedbor contributed a <a href="matrix.pike">Pike</a> program that
...
<ul>
  ...
  arrays.</li>
  <li>Anton Ertl submitted an alternative for <a href=
  "alt/matrix.gforth2.gforth">GForth</a> that uses integers.</li>
  <li>Jorge Acereda Maciá submitted an interesting alternative for <a
  href="alt/matrix.gforth3.gforth">GForth</a> that generates inlined
  code at compile time.</li>
</ul>
