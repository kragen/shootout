...
<p>
  Please Note:  This test will needs to be re-designed a little to
  avoid the creation of invariant objects.
<p>
  For this test, each program should be implemented in the <a
  href="../../method.shtml#sameway"><i>same way</i></a>.
<p>
  This test attempts to measure the speed of object instantiation in
  OO languages.  It measures a mixture of creation of objects from
  base and derived classes.
<p>
  These classes are also used in the <a href="../methcall/">Method
  Calls</a> test.  (See that page for more description of the test).
<p>
  The correct output looks like <a href="Output">this</a>.

<h4>Observations</h4>
<p>
  The <a href="objinst.se">SmallEiffel solution</a> (submitted by
...
<p>
  A modest speedup could be achieved in the Perl solution by using an
  ...
  the improvements Perl 6 will bring to OOP in Perl.
...
<ul>
<li>
 Here's an alternate <a href="alt/objinst.cmucl2.cmucl">CMUCL</a>
 program that uses defclass to define objects as opposed to the use of
 defstruct in the current entry.
</ul>
