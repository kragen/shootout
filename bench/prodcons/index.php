...
<p><b>Please Note:</b> this test is due for an overhaul, so that
...
<p>This is a test of thread synchronization using a simple threaded
...
<h4>Observations</h4>
<p>Haskell and MLton appear to be so much faster because they do not
  use Linux kernel threads, which are fairly heavyweight when doing
  things like switching thread context.</p>
<p>Most of the compiled languages here allow you to build threaded
  ...
  non-threaded tests, I use a regular old Perl built without threads.</p>
...
<ul>
  <li>Brad Knotwell contributed a <a href="alt/prodcons.python2.python">Python
  ...
  Queues too (e.g. Perl's Thread::Queue).</li>
  <li>Bernd Paysan submitted forth entries for <a
  ...
  aren't pre-emptive.</li>
  <li>Cheyenne Wills contributed a producer/consumer <a
