...
<p>The purpose of this test is to try to show relative startup costs of
  ...
  times in a loop by a shell script wrapper.</p>
<p>I use the results of this test to calculate CPU times on other tests
  ...
  of the table on this page :-).</p>

<h4>Observations</h4>
<p>A number of the programs run so quickly so that memory can't be
  measured by my memory sampling method.  For this test, you should
  really ignore the memory results.</p>
