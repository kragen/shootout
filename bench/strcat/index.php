...
<p>
  ...
  href="../../method.shtml#sameway"><i>same way</i></a>, according to
...
<p>
  This test should probably be called the <i>string append</i> test
...
<p>
  This is an extremely simple test that measures speed of a language's
  ...
  this at one time is too much of a cheat.
<p>
  Due to the number of alternative ways of <i>concatenating a string</i>
...
<p>
  ...
  <a href="strcat.xemacs2.xemacs">XEmacs (2)</a>.
<p>
  This test shows how well a language handles string allocation with
  ...
  analogous string append, which is much faster).
<p>
  Josef Svenningsson observes that when using the <a
...
<p>
  This test was suggested by Ben Tilly.
<p>
  Friedrich Dominicus who supplied the SmallEiffel solution, also
...
<ul>
<li>
  You can produce repeated strings in Perl via the <b>x</b> operator,
  ...
  one in <a href="alt/strcat.pike3.pike">Pike</a> from Per Hedbor.
<li>
  Here are some programs that join a list of strings: 
