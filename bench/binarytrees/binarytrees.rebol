...
print ["stretch tree of depth" stretch-depth "^-check:" check-item stretched-tree]
...
print ["long lived tree of depth" n "^-check:" check-item longlived-tree]