/* The Computer Language Shootout
   ...
   modified by Richard Warburton on 29th Oct. 2006
*/
...
public class pidigits {
   ...
   public static void main(String args[]) {
      ...
      while (n > 0){
         if (n >= L){
            for (int i=0; i<L; i++) sb.append( digits.next() );
            j += L;
         } else {
            for (int i=0; i<n; i++) sb.append( digits.next() );
            for (int i=n; i<L; i++) sb.append(" ");
            j += n;
         }
