...
<p>In this test, we create 10000 hash entries, then add them into a new
  hash N times.</p>
<p>This is an attempt to improve on the original <a href="../hash/">hash
...
<p>SmallEiffel version 0.77 was able to complete this test in about
  7CPU seconds.  The new version (0.76, they count backwards?!) dumps
  core.</p>
<p>The <a href="hash2.gcc">C program</a> uses a simple Hash Table
...
<ul>
  <li>Miguel Sofer submitted a somewhat faster version of the <a
