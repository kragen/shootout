...
<p>
  Each program reads the input from standard input, and counts the
  ...
  All other solutions should be implemented natively.
<p>
  This test is essentially the same as the wordcount test from <a
  href="http://cm.bell-labs.com/cm/cs/who/bwk/interps/pap.html">
  Timing Trials, or, the Trials of Timing: Experiments with Scripting
  and User-Interface Languages</a> by Brian W. Kernighan and
  Christopher J. Van Wyk.
<p>
  Note that as in the original version of this test, whitespace is
...
<p>
  The programs can assume that the file ends in a newline, and they
  should be able to handle arbitrarily long lines.

<p>
  <a href="/data/shootout/wc/Input">Input</a> file (it
  is repeated N times).<br>
<p>
  The correct output (for N = 500, i.e. a 500 copies of the input)
  looks like this:
<pre>
  12500 68500 3048000
</pre>
...
<h4>Observations</h4>
<p>
  The original <a href="alt/wc.gcc2.gcc">C program</a> is significantly
