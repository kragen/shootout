...
<p>This is a highly contrived test that exercises various <i>list</i>
  ...
  those places where we allow builtin list functions.</p>
<p>The test can use whichever sequence data structure is best suited
  ...
  number of languages benefit from creating a custom data structure.</p>
<p>Here's a description of how each test program works:</p>
<ul>
  <li>first create a list (L1) of integers from 1 through SIZE (SIZE is
  currently defined as 10000).</li>
  <li>copy L1 to L2 (can use any builtin list copy function, if available)</li>
  ...
  <li>reverse L1 (preferably in place) (can use any builtin function for
  this, if available).</li>
  <li>check that first item of L1 is now == SIZE.</li>
  <li>and compare L1 and L2 for equality and return length of L1 (which
...
<p>The <a href="lists.se">SmallEiffel program</a> uses a custom
  DOUBLY_LINKED_LIST class implemented in this header file: <a
  href="../Include/doubly_linked_list.e">doubly_linked_list.e</a>.</p>
...
<ul>
  <li>My original <a href="alt/lists.lua.tables">lua test</a>
  ...
  array data type.</li>
  <li>Julian Assange contributed a very beautiful example in <a
