...
<?php require("../../html/testtop.php");
      testtop("Nested Loops"); ?>

<h4>About this test</h4>
<p>For this test, each program should be implemented in the <a
  href="../../method.php#sameway"><i>same way</i></a>.</p>
<p>This is just a simple test to try to measure loop overhead for a
  loop that does something a number of times.</p>
...
<ul>
  <li>Miguel Sofer contributed another <a href="alt/nestedloop.tcl2.tcl">Tcl
  program</a>, which reads nicely, but is fractionally slower than the
  current Tcl contestant.</li>
  <li>In Ocaml, it can be faster to write your loops using <a
  href="nestedloop.ocaml">recursion</a>.  A slightly slower version
  that uses Ocaml's imperative loop control is shown <a
  href="alt/nestedloop.ocaml2.ocaml">here</a>.</li>
</ul>
