...
<p>This test implements a in-place heap sort function that takes
...
<p>In order to be able to add bigloo I had to use different constants
  ...
  a C integer.</p>
<p>The SmallEiffel <a href="heapsort.se">program</a> uses an externally
  defined <a href="../Include/randomnumber.e">class</a> to generate
  the random numbers to sort.</p>
...
<ul>
 <li>The Perl code uses a local alias (typeglob) for the passed array
  ...
  reference which is a little slower than using the typeglob.</li>
</ul>
