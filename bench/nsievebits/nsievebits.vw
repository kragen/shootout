...
nsieveBits
    ...
    isComposite := ComputerLanguageShootout.BitArray new: self.
    count := 0.
    2 to: self do: [ :i |
...
Smalltalk.ComputerLanguageShootout defineClass: #BitArray
...
!ComputerLanguageShootout.BitArray class methodsFor: 'instance creation'!

new: size
    ^super new: (size + 7 bitShift: -3)! !


!ComputerLanguageShootout.BitArray methodsFor: 'accessing'!
