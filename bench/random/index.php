...
<p>The purpose of this test is to implement a function that generates
...
<p>For this test I would like to see each program use symbolic
...
<p>In order to be able to add bigloo I had to use different constants
  ...
  a C integer.</p>
<p>The <a href="random.se">SmallEiffel solution</a> (submitted by
  Steve Thompson) is implemented in multiple files.  See also the <a
  href="../Include/randomnumber.e">RandomNumber</a> class.</p>
<p>The following programs are currently disqualified because they don't
...
<ul>
  <li>Miguel Sofer has contributed a very fast <a href="random.tcl">Tcl
  solution</a> that deserves mention because of the dramatic speedup
  he has accomplished.  Read more about it <a
  href="http://mini.net/cgi-bin/wikit/1173.html">here</a>.</li>
  <li>Here's the original <a href="alt/random.tcl2.tcl">Tcl solution</a> from
  Kristoffer Lawson, which is arguably written in a more conventional Tcl
  style than the faster version from Miguel.</li>
</ul>
