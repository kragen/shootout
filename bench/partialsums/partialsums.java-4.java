...
class partialsums {
   ...
   public static void main(String[] args){
      ...
      for (int k=1; k<=n; k++){
        ...
        // the following can probably be improved with a better algoritm 
        // to deal with all n values..
        a4 *= 1.0000000007927554;       
       if (n  >= 600000)
      	    a5 *= 1.0000000007568576;	 	    	
...
{   
   ...
   public static double OneFourthPI = PI / 4;
