...
# $Id: u32q.programs.Makefile,v 1.32 2009-08-27 22:33:37 igouy-guest Exp $
...
%.fsharp_run: %.fs
	-$(MONORUN) $(FSHARPC) -r FSharp.PowerPack.dll --platform x86 -O --cliversion 3.5 $(FSHARPOPTS) -o $@.exe $<
